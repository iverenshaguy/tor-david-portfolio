...
export function Project({
  ...
  return (
    <div
      ...
      className={`group h-[494px] w-full overflow-hidden ${className} cursor-pointer rounded-[40px] bg-white p-4 md:cursor-default`}
    >
      <div className="p-0">
        <div className="flex flex-col items-center gap-10 md:flex-row">
          ...
          <div className="flex w-full flex-col gap-[30px] bg-white">
            <div className="flex flex-col gap-2.5">
              <div className="flex flex-col gap-2.5 py-[5px]">
                <h3 className="w-full text-2xl font-semibold text-black">
                  {project.title}
                </h3>
              ...
              <div className="flex flex-col gap-2.5 py-[5px]">
                <h4 className="text-xl font-medium text-black">ROLE</h4>
                <p className="text-lg font-bold text-black">{project.role}</p>
                <p className="text-lg text-black">{project.responsibilities}</p>
              </div>
            </div>
            ...
            >
              <span className="left-6 text-white">View Design</span>
              <svg
